...
CXXFLAGS  = -O2 -Wno-format-extra-args -Wno-format -fpic -fexceptions -fno-strict-aliasing -ffunction-sections -gline-tables-only -fomit-frame-pointer -fdata-sections -fno-ms-compatibility -fms-extensions -fno-short-enums -D_WIN32_WINNT=0x0601 -D_CONSOLE -DNDEBUG -DNOMINMAX -D_MT -D_DLL -D_CRT_SECURE_NO_WARNINGS
# -DBOOST_ALL_DYN_LINK
